...
const string world_file = "../resources/01-hapticData1Robot/world.urdf";
...
string GUIDANCE_PLANE_NORMAL_KEY = "sai2::rubberDuckyApplications::simulation::guidance_plane_normal_vec";
string GUIDANCE_PLANE_POINT_KEY = "sai2::rubberDuckyApplications::simulation::guidance_plane_point";
string ROBOT_HAPTIC_ROTATION_MATRIX_KEY = "sai2::rubberDuckyApplications::simulation::robot_haptic_rotation_matrix_guidance";
string ROBOT_HAPTIC_FRAME_TRANSLATION_KEY = "sai2::rubberDuckyApplications::simulation::robot_haptic_frame_translation_guidance";
string GUIDANCE_LINE_FIRST_POINT = "sai2::rubberDuckyApplications::simulation::line_guidance_first_point";
string GUIDANCE_LINE_SECOND_POINT = "sai2::rubberDuckyApplications::simulation::line_guidance_second_point";
const string GUIDANCE_PLANE_ENABLE = "sai2::rubberDuckyApplications::simulation::_enable_plane_guidance_3D";
// const string GUIDANCE_LINE_ENABLE = "sai2::rubberDuckyApplications::simulation::_enable_line_guidance_3D";
string GUIDANCE_SCALE_FACTOR = "sai2::rubberDuckyApplications::simulation::_guidance_scale_factor";
...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(windowW, windowH, "SAI2.0 - rubberDuckyApplications", NULL, NULL);
