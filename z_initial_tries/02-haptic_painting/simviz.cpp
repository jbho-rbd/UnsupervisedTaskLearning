...
const string world_file = "./resources/02-haptic_painting/world.urdf";
const vector<string> robot_files = {
	"../resources/02-haptic_painting/panda_arm_palette.urdf",
	"../resources/02-haptic_painting/panda_arm_brush.urdf",
};
